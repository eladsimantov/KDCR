...
% Calc the system actual dynamics (actual dynamics depend on real mass)
[H_mat,C_mat,G_mat] = dynamics_mat([q1,q2,q3],[q_dot_1,q_dot_2,q_dot_3], M_real);

tau = tau_cont([q1,q2,q3],[q_dot_1,q_dot_2,q_dot_3], t, "ID"); % unaware of change if it is Q3.
