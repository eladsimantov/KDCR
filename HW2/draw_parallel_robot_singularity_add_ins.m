function [] = draw_parallel_robot_singularity_add_ins(x, q, singular_direction)
%DRAW_PARALLEL_ROBOT_ADD_INS accepts both task and joint variables, plots the robot
%and saves the figure, with added visuals to illustrate intersection of
%lines in the FK singular state.
